...
return [
    ...
    */
    ...
    'logo' => '<b><span style="font-size: 21px;">SITA</span></b>',
    ...
    */
    ...
    'auth' => [
        'login_view' => 'auth.login',  // Change to your custom login view path
        'login_url' => 'login',  // Make sure this matches your login route
    ],
    ...
    */
    ...
    'classes_content' => '',
    'classes_sidebar' => 'sidebar-white  elevation-4',
    'classes_sidebar_nav' => '',
    ...
    */
    ...
    'use_route_url' => false, // Set to false, since you're not using the route URLs provided by AdminLTE
    ...
    */
    ...
    // Navbar items:
        ...
        [ 
            ...
            'submenu' => [
                [
                    'text' => 'Thesis Seminar 1',
                    'url' => 'thesis1',
                    'icon' => 'fas fa-graduation-cap' // FontAwesome icon for Seminar 1
                ],
                [
                    'text' => 'Thesis Seminar 2',
                    'url' => 'thesis2',
                    'icon' => 'fas fa-graduation-cap' // FontAwesome icon for Seminar 2
                ],
            ],

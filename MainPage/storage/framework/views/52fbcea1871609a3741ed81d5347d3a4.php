    ...
    <main class="flex-1 container mx-auto px-4 py-12">
        <div class="bg-white rounded-lg shadow-md p-8 max-w-4xl mx-auto fade-in">
            ...
            <div class="mt-10 text-center fade-in" style="animation-delay: 1s;">
                <a href="/"
                    class="inline-block text-lg text-blue-800 border border-blue-800 px-4 py-2 rounded-lg hover-scale hover:bg-blue-800 hover:text-white transition-colors duration-300 back-button">Kembali
                    ke Halaman Utama</a>
            </div>
        </div>
    </main>
...
<?php /**PATH D:\Proyek SMA 1\pabwe-pkm-proyek-2024-k1\MainPage\resources\views/sarana/uks.blade.php ENDPATH**/ ?>
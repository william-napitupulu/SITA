...
<body class="flex flex-col min-h-screen bg-white text-gray-800 font-sans">
    <!-- Header -->
    <header class="bg-blue-800 text-white text-center py-5 shadow-md">
...
<?php /**PATH D:\Proyek SMA 1\pabwe-pkm-proyek-2024-k1\MainPage\resources\views/prof/prestasi.blade.php ENDPATH**/ ?>
    ...
    <main class="flex-1 container mx-auto px-4 py-10">
        <div class="bg-white min-h-full">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <select id="year-select" class="border border-gray-300 rounded-lg p-2 text-gray-600"
                    onchange="showPrestasi(this.value)">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 max-w-5xl mx-auto">
                <p class="text-lg mb-6 text-gray-700">SMAN 1 Balige telah meraih berbagai prestasi membanggakan, baik di
                    tingkat lokal, nasional, maupun internasional. Silakan pilih tahun untuk melihat detail prestasi.
                </p>
            </div>


            <!-- Bagian Prestasi Tahun 2017 -->
            <div id="prestasi-2017" class="prestasi-section bg-white rounded-lg shadow-lg p-8 max-w-5xl mx-auto"
                style="display: none;">
                ...
                <div class="space-y-8">
                    <div class="bg-gray-50 border border-gray-200 p-6 rounded-lg hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-700 mt-2">Tim SMAN 1 Balige berhasil meraih Juara 1 dalam Lomba Cerdas
                            Cermat tingkat provinsi.</p>
                    </div>
                    <div class="bg-gray-50 border border-gray-200 p-6 rounded-lg hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-700 mt-2">Siswa SMAN 1 Balige memenangkan Olimpiade Sains tingkat kabupaten
                            dengan prestasi di bidang Matematika dan Biologi.</p>
                    </div>
                </div>
            </div>

            <!-- Bagian Prestasi Tahun 2018 -->
            <div id="prestasi-2018" class="prestasi-section bg-white rounded-lg shadow-lg p-8 max-w-5xl mx-auto"
                style="display: none;">
                ...
                <div class="space-y-8">
                    <div class="bg-gray-50 border border-gray-200 p-6 rounded-lg hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-700 mt-2">Kelompok tari SMAN 1 Balige meraih Juara 2 dalam Lomba Seni Tari
                            Tradisional tingkat nasional.</p>
                    </div>
                </div>
            </div>

            <!-- Bagian Prestasi Tahun 2019 -->
            <div id="prestasi-2019" class="prestasi-section bg-white rounded-lg shadow-lg p-8 max-w-5xl mx-auto"
                style="display: none;">
                ...
                <div class="space-y-8">
                    <div class="bg-gray-50 border border-gray-200 p-6 rounded-lg hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-700 mt-2">Siswa SMAN 1 Balige memenangkan Olimpiade Sains Nasional dengan
                            medali emas di bidang Fisika.</p>
                    </div>
                </div>
            </div>

            <!-- Bagian Prestasi Tahun 2020 -->
            <div id="prestasi-2020" class="prestasi-section bg-white rounded-lg shadow-lg p-8 max-w-5xl mx-auto"
                style="display: none;">
                ...
                <div class="space-y-8">
                    <div class="bg-gray-50 border border-gray-200 p-6 rounded-lg hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-700 mt-2">Tim Matematika SMAN 1 Balige berhasil meraih Juara 1 dalam
                            kompetisi Matematika tingkat nasional.</p>
                    </div>
                </div>
            </div>

            <!-- Bagian Prestasi Tahun 2021 -->
            <div id="prestasi-2021" class="prestasi-section bg-white rounded-lg shadow-lg p-8 max-w-5xl mx-auto"
                style="display: none;">
                ...
                <div class="space-y-8">
                    <div class="bg-gray-50 border border-gray-200 p-6 rounded-lg hover:shadow-xl transition-shadow">
                        ...
                        <p class="text-gray-700 mt-2">Tim debat bahasa Inggris SMAN 1 Balige berhasil meraih Juara 3
                            dalam lomba debat tingkat internasional.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-center mt-10">
            <a href="/"
                class="text-lg text-blue-800 border border-blue-800 px-6 py-2 rounded hover:bg-blue-800 hover:text-white transition-colors">Kembali
                ke Halaman Utama</a>
        </div>
    </main>
...
</html><?php /**PATH D:\Kuliah\Del\Semester 5\Pabwe\Praktikum\Proyek SMA 1\pabwe-pkm-proyek-2024-k1\MainPage\resources\views/prof/prestasi.blade.php ENDPATH**/ ?>
...
<body class="flex flex-col min-h-screen bg-gray-100 text-gray-800 font-sans">
    ...
    <main class="flex-1 container mx-auto px-4 py-10">
        ...
        <h1 class="text-3xl font-semibold text-blue-800 mb-6 text-center">Hubungi Kami</h1>
...
</html><?php /**PATH D:\Kuliah\Del\Semester 5\Pabwe\Praktikum\Proyek SMA 1\pabwe-pkm-proyek-2024-k1\MainPage\resources\views/info/hubungi.blade.php ENDPATH**/ ?>
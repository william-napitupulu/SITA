...
<style>
    /* Reduce the spacing between Remember Me/Log In and the links below */
    .auth-footer-links {
        margin-top: -20px;
        /* Adjust this value to get closer spacing */
        font-size: 0.875rem;
...
<div class="row auth-footer-links">
    
    <div class="col-6 text-left">
        <?php if($password_reset_url): ?>
            <a href="<?php echo e($password_reset_url); ?>" class="text-sm">
    ...
    <div class="col-6 text-right">
        <?php if($register_url): ?>
            <a href="<?php echo e($register_url); ?>" class="text-sm">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEL\Semester V\Pengembangan Aplikasi Berbasis Web\pkm\pabwe-pkm-proyek-2024-k1\AdminPage\vendor\jeroennoten\laravel-adminlte\src/../resources/views/auth/login.blade.php ENDPATH**/ ?>